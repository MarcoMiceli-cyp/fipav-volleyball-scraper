...
<div class="em-header">
    ...
    <div class="em-stats">
        ...
        <div class="em-stat">
            ...
            <span class="em-stat-lbl">Forma</span>
        </div>
        <?php endif; ?>
    </div>
    <?php endif; ?>
    <button class="vb-icon-btn" id="btn-theme" title="Cambia tema" style="flex-shrink:0">
...
document.querySelectorAll('.vb-tab').forEach(tab => {
    tab.addEventListener('click', () => {
        ...
        /* Notifica il parent per il resize dell'iframe */
...
/* Auto-resize: notifica il parent dell'altezza reale */
